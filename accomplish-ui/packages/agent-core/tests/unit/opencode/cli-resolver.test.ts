...
describe('CLI Resolver', () => {
  ...
  describe('resolveCliPath', () => {
    ...
    itIfWindows('resolves development CLI via opencode-ai launcher realpath in pnpm layout', () => {
      ...
      // Use a junction (no elevated privileges needed on Windows) so that
      // realpathSync naturally resolves launcherPath to realLauncherPath,
      // avoiding vi.spyOn which cannot redefine ESM exports.
