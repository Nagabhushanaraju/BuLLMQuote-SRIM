...
>(function SelectDropdown(
  ...
  // pointer-events:auto is required because Radix Dialog sets pointer-events:none on
  // document.body when open (disableOutsidePointerEvents) and only re-enables it on
  // its own portal container — this portal goes to body directly, so we must opt back in.
